...
clf4 = lgb.LGBMClassifier(criterion="logloss")#n_estimators:估计器(树)的个数  criterion:优化目标 
...
以set 左边是训练集，右边是测试集的logloss
'''

eval_set = [(X_train, y_train),(X_test, y_test)]
model4.fit(X_train, y_train, early_stopping_rounds=24, eval_metric="logloss", eval_set=eval_set, verbose=True)
